  ...
  def create
    ...
    respond_to do |format|
      if @ingredient_category.save
        format.html { redirect_to ingredient_category_url(@ingredient_category), notice: "Ingredient category was successfully created." }
  ...
  def update
    respond_to do |format|
      if @ingredient_category.update(ingredient_category_params)
        format.html { redirect_to ingredient_category_url(@ingredient_category), notice: "Ingredient category was successfully updated." }
