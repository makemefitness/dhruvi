(() => {
  ...
  // app/javascript/components/chosen.jquery.js
  var require_chosen_jquery = __commonJS({
    "app/javascript/components/chosen.jquery.js"(exports) {
      (function() {
        var $3, AbstractChosen, Chosen, SelectParser, bind = function(fn3, me2) {
          return function() {
        ...
        SelectParser = function() {
          ...
          SelectParser2.prototype.add_group = function(group) {
            var group_position, i2, len, option, ref, results1;
        ...
        AbstractChosen = function() {
          ...
          AbstractChosen2.prototype.set_default_values = function() {
            this.click_test_action = /* @__PURE__ */ function(_this) {
              return function(evt) {
                return _this.test_active_click(evt);
              };
            }(this);
            this.activate_action = /* @__PURE__ */ function(_this) {
              return function(evt) {
          ...
          AbstractChosen2.prototype.results_option_build = function(options) {
            var content, data, data_content, i2, len, ref, shown_results;
            content = "";
            shown_results = 0;
          ...
          AbstractChosen2.prototype.reset_single_select_options = function() {
            var i2, len, ref, result, results1;
            ref = this.results_data;
            results1 = [];
            for (i2 = 0, len = ref.length; i2 < len; i2++) {
              result = ref[i2];
          ...
          AbstractChosen2.prototype.winnow_results = function(options) {
            var escapedQuery, fix, i2, len, option, prefix, query, ref, regex, results, results_group, search_match, startpos, suffix, text;
        ...
        Chosen = function(superClass) {
          ...
          Chosen2.prototype.register_observers = function() {
            this.container.on("touchstart.chosen", /* @__PURE__ */ function(_this) {
              return function(evt) {
                _this.container_mousedown(evt);
              };
            }(this));
            this.container.on("touchend.chosen", /* @__PURE__ */ function(_this) {
              return function(evt) {
                _this.container_mouseup(evt);
              };
            }(this));
            this.container.on("mousedown.chosen", /* @__PURE__ */ function(_this) {
              return function(evt) {
                _this.container_mousedown(evt);
              };
            }(this));
            this.container.on("mouseup.chosen", /* @__PURE__ */ function(_this) {
              return function(evt) {
                _this.container_mouseup(evt);
              };
            }(this));
            this.container.on("mouseenter.chosen", /* @__PURE__ */ function(_this) {
              return function(evt) {
                _this.mouse_enter(evt);
              };
            }(this));
            this.container.on("mouseleave.chosen", /* @__PURE__ */ function(_this) {
              return function(evt) {
                _this.mouse_leave(evt);
              };
            }(this));
            this.search_results.on("mouseup.chosen", /* @__PURE__ */ function(_this) {
              return function(evt) {
                _this.search_results_mouseup(evt);
              };
            }(this));
            this.search_results.on("mouseover.chosen", /* @__PURE__ */ function(_this) {
              return function(evt) {
                _this.search_results_mouseover(evt);
              };
            }(this));
            this.search_results.on("mouseout.chosen", /* @__PURE__ */ function(_this) {
              return function(evt) {
                _this.search_results_mouseout(evt);
              };
            }(this));
            this.search_results.on("mousewheel.chosen DOMMouseScroll.chosen", /* @__PURE__ */ function(_this) {
              return function(evt) {
                _this.search_results_mousewheel(evt);
              };
            }(this));
            this.search_results.on("touchstart.chosen", /* @__PURE__ */ function(_this) {
              return function(evt) {
                _this.search_results_touchstart(evt);
              };
            }(this));
            this.search_results.on("touchmove.chosen", /* @__PURE__ */ function(_this) {
              return function(evt) {
                _this.search_results_touchmove(evt);
              };
            }(this));
            this.search_results.on("touchend.chosen", /* @__PURE__ */ function(_this) {
              return function(evt) {
                _this.search_results_touchend(evt);
              };
            }(this));
            this.form_field_jq.on("chosen:updated.chosen", /* @__PURE__ */ function(_this) {
              return function(evt) {
                _this.results_update_field(evt);
              };
            }(this));
            this.form_field_jq.on("chosen:activate.chosen", /* @__PURE__ */ function(_this) {
              return function(evt) {
                _this.activate_field(evt);
              };
            }(this));
            this.form_field_jq.on("chosen:open.chosen", /* @__PURE__ */ function(_this) {
              return function(evt) {
                _this.container_mousedown(evt);
              };
            }(this));
            this.form_field_jq.on("chosen:close.chosen", /* @__PURE__ */ function(_this) {
              return function(evt) {
                _this.close_field(evt);
              };
            }(this));
            this.search_field.on("blur.chosen", /* @__PURE__ */ function(_this) {
              return function(evt) {
                _this.input_blur(evt);
              };
            }(this));
            this.search_field.on("keyup.chosen", /* @__PURE__ */ function(_this) {
              return function(evt) {
                _this.keyup_checker(evt);
              };
            }(this));
            this.search_field.on("keydown.chosen", /* @__PURE__ */ function(_this) {
              return function(evt) {
                _this.keydown_checker(evt);
              };
            }(this));
            this.search_field.on("focus.chosen", /* @__PURE__ */ function(_this) {
              return function(evt) {
                _this.input_focus(evt);
              };
            }(this));
            this.search_field.on("cut.chosen", /* @__PURE__ */ function(_this) {
              return function(evt) {
                _this.clipboard_event_checker(evt);
              };
            }(this));
            this.search_field.on("paste.chosen", /* @__PURE__ */ function(_this) {
              return function(evt) {
                _this.clipboard_event_checker(evt);
              };
            }(this));
            if (this.is_multiple) {
              return this.search_choices.on("click.chosen", /* @__PURE__ */ function(_this) {
                return function(evt) {
          ...
          Chosen2.prototype.set_tab_index = function(el) {
            ...
            if (this.form_field.tabIndex) {
              ti2 = this.form_field.tabIndex;
              this.form_field.tabIndex = -1;
              return this.search_field[0].tabIndex = ti2;
            }
          };
          ...
          Chosen2.prototype.choice_build = function(item) {
            ...
            if (item.disabled) {
              ...
              close_link.on("click.chosen", /* @__PURE__ */ function(_this) {
                return function(evt) {
          ...
          Chosen2.prototype.search_field_scale = function() {
            var div, i2, len, style, style_block, styles, width;
            if (!this.is_multiple) {
              return;
            }
            style_block = {
